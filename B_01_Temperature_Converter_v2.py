...
class Converter():
    ...
    def __init__(self):
        ...
        self.answer_error = Label(self.temp_frame, text=has_error,
        ...
        # Lists to hold buttons once they have been made
    ...
    def to_help(self):
        ...
        (so that user's can't create multiple help boxes).
        """
        DisplayHelp(self)
...
class HistoryExport:
    ...
    def __init__(self, partner, calculations):
        ...
        # Retrieve export instruction label so that we can configure it to show the filename if the user exports
